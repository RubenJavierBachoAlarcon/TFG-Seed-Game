...
public class ChangeScene : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            if (nivelActual != "Nivel 1 - Monta�a")
            {
    ...
    IEnumerator UpdateScore()
    {
        ...
        finalScore = (int)(100000 / finalTime); // Aumenta el numerador para obtener una puntuaci�n m�s alta
        ...
        while (currentScore < finalScore)
        {
            while (currentScore < finalScore)
            {
                currentScore += (int)(finalScore * Time.deltaTime * 0.2f); // Aumenta el factor de incremento para que la puntuaci�n se incremente m�s r�pido
